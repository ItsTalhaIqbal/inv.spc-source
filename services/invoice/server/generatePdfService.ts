    ...
    .map((item: Item, index: number) => {
      ...
      return `
        <tr class="border">
          ...
          <td class="w-[40%] font-sans leading-tight text-center text-black text-base border px-2 py-1 description-cell" style="word-wrap: break-word; white-space: normal;"><pre class="text-start"> ${
            item.name || ""
          }</pre></td>
