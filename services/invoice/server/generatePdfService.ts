...
contact@spcsource.com</p>
        <p  class="flex"><svg class="w-3 h-3  text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="3" fill="currentColor" viewBox="0 0 24 24">
