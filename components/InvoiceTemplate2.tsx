...
const log = (message: string, level: 'info' | 'error' | 'debug' = 'info', data?: any) => {
  console[level](`[InvoiceTemplate2] ${message}`, data ? JSON.stringify(data, null, 2) : '');
};
...
const InvoiceTemplate2: React.FC<InvoiceType> = (data: InvoiceType) => {
  log('Rendering template with data', 'info', data);
    ...
    <InvoiceLayout data={data}>
        ...
        <div className="my-4">
          <div className="my-2">
            ...
            <p className="font-regular text-gray-800">
              {details.additionalNotes || "N/A"}
            </p>
          </div>
          <div className="my-2">
            <p className="font-semibold text-blue-600">Payment terms:</p>
            <p className="font-regular text-gray-800">{details.paymentTerms || "N/A"}</p>
          </div>
          <div className="my-2">
            <span className="font-semibold text-md text-gray-800">
              Please send the payment to this address
              <p className="text-sm">
                Bank: {details.paymentInformation?.bankName || "N/A"}
              </p>
              <p className="text-sm">
                Account name: {details.paymentInformation?.accountName || "N/A"}
              </p>
              <p className="text-sm">
                Account no: {details.paymentInformation?.accountNumber || "N/A"}
              </p>
            </span>
          </div>
        </div>
      ...
      <div className="mt-1">
        ...
        <div className="mt-2 border-t border-gray-200 pt-4">
          <div className=" bg-orange-400 text-black p-2 flex justify-between items-center">
