...
const Page = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-xs sm:max-w-md mb-4">
          ...
          >
            <TableHeader>
              <TableRow className={theme === "dark" ? "bg-gray-700" : "bg-gray-100"}>
                ...
                <TableHead className={`hidden sm:table-cell ${theme === "dark" ? "text-white" : "text-black"}`}>
                  Email
                </TableHead>
                <TableHead className={theme === "dark" ? "text-white" : "text-black"}>
                  Phone
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        ...
        >
          <DialogHeader>
            ...
            {error && <div className="text-sm sm:text-lg text-red-500">{error}</div>}
          </DialogHeader>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        ...
        >
          ...
          <p className="text-sm sm:text-base">Are you sure you want to delete {deleteUserName}?</p>
