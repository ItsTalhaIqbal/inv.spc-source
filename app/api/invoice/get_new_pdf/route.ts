  ...
  <body>
    ...
    <div class="footer w-full">
      ...
      <div class="flex justify-between h-[10px] mt-1 p-2 w-full" style="background-color: #FFA733;">
        <p class="flex"> <svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="4" height="4" fill="none" viewBox="0 0 24 24">
